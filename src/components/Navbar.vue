  ...
  <header class="navbar">
    <div class="navbar__inner">
      <router-link
        to="/"
        class="navbar__logo"
        aria-label="Junior Connect home"
      ...
      -->
            <router-link to="/profile" class="navbar__profile">
              <div
                class="w-9 h-9 rounded-full border border-indigo-300 overflow-hidden flex items-center justify-center text-indigo-500 bg-white"
              >
                <img
                  v-if="avatarUrl"
                  :src="avatarUrl"
